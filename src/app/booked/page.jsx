		...
		<>
			...
			<div className='min-h-screen w-full'>
				{items.length > 0 ? (
					...
					<p className='flex items-center justify-center text-rose-700 font-extrabold text-center py-4 text-3xl'>
						Seems Not yet Booked{" "}
						<Link className='text-slate-400' href='/cart'>
							Click Here
						</Link>
					</p>
				)}
